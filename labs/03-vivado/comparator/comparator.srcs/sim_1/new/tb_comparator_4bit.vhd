...
begin
    ...
    begin
        ...
        s_b <= "1111"; s_a <= "0110"; wait for 100 ns;
                ...
                (s_B_equals_A  = '0') and 
                (s_B_less_A    = '1')) --Mistake made here to test assert/report
        report "Input combination 1111, 0110 FAILED" severity error;
        s_b <= "1010"; s_a <= "1001"; wait for 100 ns;
                assert ((s_B_greater_A = '1') and
                (s_B_equals_A  = '0') and
                (s_B_less_A    = '0'))
        report "Input combination 1010, 1001 FAILED" severity error;
        ...
        s_b <= "1100"; s_a <= "1100"; wait for 100 ns;
                ...
                (s_B_equals_A  = '1') and
                (s_B_less_A    = '0'))
        report "Input combination 1100, 1100 FAILED" severity error;
        --Last two digits of my ID are: 79
